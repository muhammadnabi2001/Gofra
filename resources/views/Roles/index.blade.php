                                    ...
                                    @foreach ($roles as $index => $role)
                                        <tr>
                                            ...
                                            <td class="text-center"><!-- Button trigger modal -->
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal{{$role->id}}">
                                                  ...
                                                  <div class="modal-dialog">
                                                    <div class="modal-content">
                                                      <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel{{$role->id}}">Modal title</h1>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                      </div>
                                                      <div class="modal-body">
                                                        @foreach($permissionGroups as $group)
                                                            <details class="permission-group" style="border: 1px solid #ddd; border-radius: 8px; margin: 8px 0; overflow: hidden; transition: all 0.3s ease-in-out;">
                                                                <summary style="cursor: pointer; padding: 10px; font-size: 16px; font-weight: bold; background: #1045bf; color: solid #dddddd; list-style-type: none;">
                                                                    {{ $group->name }}
                                                                </summary>
                                                                <div class="permissions" style="padding: 10px; background: #f1f3f5;">
