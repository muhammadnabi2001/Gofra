        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item has-treeview {{ Request::is('employee*') || Request::is('department*') ? 'menu-open' : '' }}">
                          <a href="#" class="nav-link {{ Request::is('employee*') || Request::is('department*') ? 'active' : '' }}">
